...
import 'package:map_widget/models/geometry.dart';
...
import 'package:map_widget/services/geolocator_service.dart';
import 'package:map_widget/services/marker_service.dart';
import 'package:map_widget/services/places_service.dart';
...
class ApplicationBloc with ChangeNotifier {
  ...
  ApplicationBloc() {
    ...
    BitmapDescriptor.fromAssetImage(
      ...
      markers.add(Marker(
      markerId: MarkerId('Spain'),
      draggable: true,
      visible: true,
      infoWindow: InfoWindow(title: 'Spain'),
      position: LatLng(	40.2085, 	-3.7130),
      icon: icon,
    ));
    });
